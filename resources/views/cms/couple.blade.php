...
@section('content')
    <div class="section__header cms-hero" style="margin-top:0;">
        ...
        <p style="color: #2b2b2b;">Voce pode ver seu casamento e adicionar convidados ao evento.</p>
    </div>
    ...
    <div class="grid" style="gap: 1rem; margin-bottom: 1rem;">
        ...
        <div class="card card--surface">
            <p class="section__subtitle" style="color: var(--color-elegancia); margin-bottom: 0.4rem;">Confirmacoes</p>
            <h3 class="service-card__title" style="color: var(--color-elegancia); margin-bottom: 0.4rem;">Confirmados</h3>
            <p style="color: #2b2b2b; font-weight: 700; font-size: 1.4rem; margin: 0;"> <span id="summary-wedding-accepted">--</span></p>
        </div>
    </div>
    ...
    <div class="card card--surface" style="margin-bottom: 1.5rem;">
        ...
        <form id="guest-form" style="margin-top: 1rem; display: grid; gap: 0.75rem;">
            ...
            <input class="input" name="cpf" placeholder="CPF (para responsavel)" maxlength="11">
            ...
            <div style="border:1px dashed rgba(0,48,44,0.2); border-radius: 12px; padding: 0.75rem 0.9rem;">
                <div style="display:flex; justify-content: space-between; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
                    <p style="color: #2b2b2b; font-weight: 700;">Dependentes deste responsavel</p>
                    <button type="button" id="add-dependent" class="btn btn--outline" style="padding: 0.5rem 0.9rem;">+ Adicionar</button>
                </div>
                <p style="color: #2b2b2b; font-size: 0.9rem; margin-bottom: 0.5rem;">Use quando este convidado for o responsavel. Nao e necessario CPF para dependentes.</p>
